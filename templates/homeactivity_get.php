...
<body>
    ...
    <?php else : ?>
        <?php foreach ($activity as $activityItem) : ?>
            <div class="activity-card" onclick="submitForm('form-<?= $activityItem['ActID'] ?>')">
                <!-- แสดงรูปภาพกิจกรรม -->
                ...
                <!-- ฟอร์มที่ซ่อน -->
                <form id="form-<?= $activityItem['ActID'] ?>" action="/detalis" method="post" name="detalis" style="display: none;">
